...
<a href="/freelancers"
    class="bg-green border-2 border-black py-3 px-5 text-xs font-semibold capitalize">{{__('website.explore_the_talents')}}</a>
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-5 ">
                            ...
                            <a href="{{ route('fav_freelancer.destroy', $favFreelancer->id) }}"
                                class="inline mx-1 antialiased text-xs font-semibold capitalize text-red-500">{{__('website.remove')}}</a>
                        </td>
                    </tr>
                @empty
                    <tr>
