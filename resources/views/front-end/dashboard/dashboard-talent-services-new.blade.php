    ...
    <form action="{{ route('freelancer-services.store') }}" method="POST">
        ...
        <div class="flex flex-col gap-5">
            <div class="flex flex-col lg:flex-row items-center gap-5">
                <div class="flex-1 flex flex-col gap-2 dashboard-field">
                    <label for="title"
                        class="text-xs font-semibold uppercase text-white">{{__('website.service')}}</label>
                    <select name="service_id" id="title" class="bg-gr border rounded-lg border-gray-200 px-3 py-2">
                ...
                <div class="flex-1 flex flex-col gap-2 dashboard-field">
                    <label for="price"
                        class="text-xs font-semibold uppercase text-white">{{__('website.price_per_unit')}}</label>
                    <input type="number" name="price_per_unit" id="price"
                        class="bg-gr border rounded-lg border-gray-200 px-3 py-2">
                </div>
            </div>
            <div class="control flex gap-5 dashboard-field">
