        ...
        <div class="p-6 px-0 pt-0 pb-2">
            <table class="w-full min-w-[640px] table-auto">
                <thead>
                    <tr>
                        <th class="border-b border-blue-50 py-3 px-5 text-left">
                            <p class="block antialiased text-[11px] font-bold uppercase">project Title
                            </p>
                        </th>
                        <th class="border-b border-blue-50 py-3 px-5 text-left">
                ...
                <tbody>
                    @forelse($freelancerProjects as $freelancerProject)
                        <tr>
                            ...
                            <td class="py-3 px-5 ">
                                <p class="block antialiased text-xs font-normal" id="dashboardProjectDescription">
                                    {{ $freelancerProject->description }}</p>
                            </td>
                            <td class="py-3 px-5 ">
                                ...
                                <a href="{{ route('freelancer-projects.edit', $freelancerProject->id) }}"
                                    class="inline mx-1 antialiased text-xs font-semibold capitalize">Edit</a>
                                <span>|</span>
                        ...
                        <div id="delete-project-modal-{{ $freelancerProject->id }}"
                            ...
                            <div class="bg-white w-3/4 m-auto p-10 border-black border-4 acworth">
                                ...
                                <form action="{{ route('freelancer-projects.destroy', $freelancerProject->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="py-3 px-5 text-center">No Projects found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
