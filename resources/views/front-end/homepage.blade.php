        ...
        <div class="my-10 flex gap-5 flex-wrap lg:flex-nowrap">
            <div class="flex flex-col gap-3">
                ...
                <a href="/talent-signup"
                    class="font-bold bg-green p-2 mt-5 border-black border-2 text-black hepta text-center text-sm">I
                    Have a
                    Talent</a>
            </div>
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="/visionary-signup"
                    class="font-bold bg-pink p-2 mt-5 border-black border-2 text-black hepta text-center text-sm">I
                    Have a
                    Vision</a>
            </div>
        </div>
