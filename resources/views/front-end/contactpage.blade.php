...
<div class="backgrounded">
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 hepta">
        ...
        <form action="{{ route('contacts.store') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="relative mt-2.5">
                        <div class="absolute inset-y-0 left-0 flex items-center">
                            <label for="country" class="sr-only">{{__('website.country')}}</label>
            ...
            <div class="mt-10">
                <button type="submit"
                    class="block w-full bg-pink px-3.5 py-2.5 text-center text-sm font-bold uppercase hover:bg-fuchsia-500 border-2 border-black text-black">{{__("website.let's_talk")}}</button>
            </div>
        </form>
    </div>
</div>
