...
@php
    ...
    $visionaryDashboardLink = Request::is('en/business-area/visionary') ? 'bg-green border-y-2 border-black' : '';
...
<div class="min-h-[calc(100vh-60px)] grid grid-cols-[18rem,_1fr] bg-gray-200 hepta">
    <aside>
        <div class="fixed h-full border-black border-r-4 bg-white w-72">
            ...
            <ul class="">
                <li class="capitalize my-4 hover:bg-green transition {{$visionaryDashboardLink}}">
