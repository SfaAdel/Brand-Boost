...
@section('title', __('sidebar.dashboard') . ' - ' . __('forms.add_new_advantage'))

@section('content')

<a href="{{ route('admin.advantages.index') }}" class="btn  m-3 btn-success ">{{ __('forms.advantages_list') }}</a>
                ...
                <div class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <h4>{{ __('forms.add_new_advantage') }}</h4>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form action="{{ route('admin.advantages.store') }}" method="POST" class="px-3"  enctype="multipart/form-data">
                                @csrf
